...
def loadProductList(keyword,pageNum):
    ...
    if keyword:
        try:
            ...
            headers = { 'cookie' : 'thw=cn cna=OtMxEPTV8UICAWJ+I+NdoV99 v=0 cookie2=1cce9138531f3cf8f8cf10ecd30dd19d t=584647c2b54261e8a03be82796b0e98d alitrackid=www.taobao.com lastalitrackid=www.taobao.com mt=ci%3D-1_0 l=ApeXvOmBilzp89FFKvx0wQ6KpwHg82sw isg=Ak5OFb0ClW7nwSE3WrnYYxqenyTaTxLJqrQ1pXiWldEC2-814F5N2PCZZbBN JSESSIONID=EB89BE85B3A6DBC64F96152D787C9C1C',
                                     'referer':'https://www.taobao.com/',
                                      'user-agent':'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36'
                    }

            url = "http://s.taobao.com/search?data-key=s&data-value="+str(valueNode)+"&ajax=true&_ksTS="+str(kstsNode)+"_2416&callback=jsonp2417&sort=sale-desc&initiative_id=tbindexz_20141103&tab=all&q="+keyword+"&style=list&s="+str(valueNode)
